...
bool testProgressBar::m_arrowAreaHovered = false;

void testProgressBar::drawComplexControl(QStyle::ComplexControl control,
...
void testProgressBar::drawArrowArea(const QStyleOptionComplex *option,
                                 QPainter *painter,
                                 const QWidget *widget) const
{
...
void testProgressBar::drawControl(QStyle::ControlElement element,
...
void testProgressBar::drawPrimitive(QStyle::PrimitiveElement element,
                                 const QStyleOption *option,
                                 QPainter *painter,
                                 const QWidget *widget) const
{
...
QSize testProgressBar::sizeFromContents(QStyle::ContentsType type,
                                     const QStyleOption *option,
                                     const QSize &size,
                                     const QWidget *widget) const
{
...
QRect testProgressBar::subControlRect(QStyle::ComplexControl cc,
...
QRect testProgressBar::subElementRect(QStyle::SubElement element,
                                   const QStyleOption *option,
                                   const QWidget *widget) const
{
