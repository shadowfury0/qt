...
#include <memory>
#include "../../GraphBuilder-main/customScrollContainer.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ScrollAreaCustom_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ScrollAreaCustom_t qt_meta_stringdata_ScrollAreaCustom = {
    {
QT_MOC_LITERAL(0, 0, 16), // "ScrollAreaCustom"
QT_MOC_LITERAL(1, 17, 15), // "scrollContainer"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 9), // "updateSpd"
QT_MOC_LITERAL(4, 44, 15), // "scrollIndicator"
QT_MOC_LITERAL(5, 60, 2) // "dp"
...
QT_INIT_METAOBJECT const QMetaObject ScrollAreaCustom::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_ScrollAreaCustom.data,
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ScrollListContainer_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ScrollListContainer_t qt_meta_stringdata_ScrollListContainer = {
    {
QT_MOC_LITERAL(0, 0, 19) // "ScrollListContainer"
...
QT_INIT_METAOBJECT const QMetaObject ScrollListContainer::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_ScrollListContainer.data,
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ScrollIndicator_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ScrollIndicator_t qt_meta_stringdata_ScrollIndicator = {
    {
QT_MOC_LITERAL(0, 0, 15), // "ScrollIndicator"
QT_MOC_LITERAL(1, 16, 10), // "scrollPage"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 14) // "setHoverActive"

    },
    "ScrollIndicator\0scrollPage\0\0setHoverActive"
};
#undef QT_MOC_LITERAL
...
void ScrollIndicator::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->setHoverActive(); break;
        default: ;
        }
...
QT_INIT_METAOBJECT const QMetaObject ScrollIndicator::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_ScrollIndicator.data,
